...
function renderComposer() {
  ...
  return `
    <section class="composer design-card">
      ...
      <label class="text-shell">
        <textarea id="record-text" maxlength="500" rows="6" placeholder="今天想留给自己的是什么？">${escapeHtml(text)}</textarea>
  ...
  return `
    <header class="main-head">
      ...
      <div class="head-actions">
        <button class="ghost" data-export type="button">⇩ 导出</button>
        <button class="ghost" data-nav-view="favorites" type="button">☆ 收藏</button>
        <button class="ghost" data-nav-view="memories" type="button">⟲ 回顾</button>
      </div>
      <div class="top-tabs">
